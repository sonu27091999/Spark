...
export class News extends Component {
    ...
    async componentDidMount() {
        console.log('cdm');
        let url = `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=e27d749b9d614d81b3ac43aab784185f&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePreviousClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=e27d749b9d614d81b3ac43aab784185f&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({ loading: true });
        let data = await fetch(url);
        let parseData = await data.json();
        // console.log(parseData);
