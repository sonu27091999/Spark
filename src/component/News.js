            ...
            <div className='container my-3'>
                ...
                <div className="row my-3">
                    <div className="col-md-4">
                        <NewsItem title='myTitle' description='mydesc' imageUrl="https://ichef.bbci.co.uk/news/1024/branded_news/92B9/production/_124616573_gettyimages-1336625644.jpg" />
                    </div>
                    <div className="col-md-4">
                        <NewsItem title='myTitle' description='mydesc' imageUrl="https://ichef.bbci.co.uk/news/1024/branded_news/92B9/production/_124616573_gettyimages-1336625644.jpg"/>
                    </div>
